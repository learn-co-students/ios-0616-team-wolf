...
class SkyScannerAPIClient {
    ...
    class func getPricesForDestination(location: Location, completion:(Int) -> ())
    {
        ...
        let stringURL = "http://partners.api.skyscanner.net/apiservices/browsequotes/v1.0/US/USD/en-US/40.7128,-74.0059-latlong/\(location.coordinates)-latlong/anytime/anytime?apiKey=\(Secrets.skyscannerAPIKey)"
