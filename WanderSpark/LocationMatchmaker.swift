...
class LocationMatchmaker {
    ...
    let matchingDictionary = ["City": ["city", "metropoli", "crowd", "busy", "bustl", "touris", "capital", "cosmopolitan", "urban", "skyscraper", "downtown"],
                              ...
                              "Historic" : ["histor", "old", "past", "plaza", "piazza", "square", "cemetery", "classic", "royal", "anniversary", "ruin", "ancient", "medieval", "castle", "palace"],
                              "Modern" : ["modern", "new", "fresh", "young", "international", "cosmopolitan", "trend", "hip",  "prosper", "innovat", "renovat", "boom", "tech", "entrepreneur", "transform", "contemporary"],
